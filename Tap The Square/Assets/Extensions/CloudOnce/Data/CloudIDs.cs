...
namespace CloudOnce
{
    ...
    public static class CloudIDs
    {
        ...
        {
            public static string MostTaps
            {
                get
                {
#if UNITY_ANDROID && !UNITY_EDITOR
#if CLOUDONCE_GOOGLE
                    return "CgkIpcHWq-0YEAIQAA";
#else
                    return string.Empty;
#endif
#elif (UNITY_IOS || UNITY_TVOS) && !UNITY_EDITOR
                    return "com.TapTheSquare3.JaeWilliams";
#elif UNITY_EDITOR
                    return "MostTaps";
#else
                    return string.Empty;
            ...
            public static string moreTaps
            {
                get
                {
#if UNITY_ANDROID && !UNITY_EDITOR
#if CLOUDONCE_GOOGLE
                    return "CgkIpcHWq-0YEAIQAQ";
#else
                    return string.Empty;
#endif
#elif (UNITY_IOS || UNITY_TVOS) && !UNITY_EDITOR
                    return "com.mostTaps.JaeWilliams";
#elif UNITY_EDITOR
                    return "moreTaps";
#else
                    return string.Empty;
